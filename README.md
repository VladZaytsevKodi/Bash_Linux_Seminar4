# Операционные системы и виртуализация (Linux) (семинары). Урок 4. Скрипты Bash


![pictures bash for linux](https://github.com/Ask1509/Linux-Seminar4-Bash/blob/main/bash.jpg)
